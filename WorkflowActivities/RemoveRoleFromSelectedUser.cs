...
{
    public class RemoveRoleFromSelectedUser : CodeActivity
    {
        [RequiredArgument]
        [Input("User")]
        ...
        protected override void Execute(CodeActivityContext executionContext)
        {
            ...
            if (userRootRoles.Any())
            {
                ...
                tracingService.Trace("Removing Role from the User");
                ...
                tracingService.Trace("Role has removed from the User");
            }
        }
    }
}
